...
public class PacketTrainPayload {
	...
	public PacketTrainPayload(byte[] stream, int length) {
		this.packet_size = length + UDP_HEADER_SIZE;
		ByteBuffer bb = ByteBuffer.wrap(Arrays.copyOfRange(stream, 0, 48));
